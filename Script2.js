...
function generateTable(sortKey) {
	...
	for (let weapon of window.weapon) {
		...
		else if	(!(greatbow.checked) && weapon["Type"] == "Great Bow"){continue;}
...
function selectinf(){
	...
	document.getElementById("magic").click();
	document.getElementById("lightning").click();
	document.getElementById("dark").click();
	document.getElementById("enchanted").click();
}