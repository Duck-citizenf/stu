...
document.querySelector(".Flynn").addEventListener('click', generateTable);
document.querySelector(".ROB").addEventListener('click', generateTable);
document.querySelector(".LightRing").addEventListener('click', generateTable);
document.querySelector(".SorceryRing").addEventListener('click', generateTable);
document.querySelector(".DarkRing").addEventListener('click', generateTable);
document.querySelector(".FireRing").addEventListener('click', generateTable);
